<template>
  <el-form class="login-container" :rules="rules" ref="sizeForm" :model="sizeForm" label-width="80px">
    ...
    <el-form-item size="large">
      <el-button type="primary" @click="onSubmit('sizeForm')">登录</el-button>
          ...
          return request.post("http://localhost:8080/user/login", this.sizeForm)
              .then(result => {
                ...
                if (jwt != null) {
                  ...
                  this.$message.error("登录失败，请检查输入信息")
                }
              })
        }
        else{
